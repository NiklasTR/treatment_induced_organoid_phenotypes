...
gg_line + ggsave(here::here("results/figures/gg_line.pdf"), width = 2, height = 8)
```
...
gg_bortezomib + ggsave(here::here("results/figures/gg_bortezomib.pdf"), width = 2, height = 8)
```
