...
#' @export
loadFeatures <- function(platename, configdir) {
  ...
  feature_names = as.character(h5read(file = feature_fn, name = "feature_names"))
...
#' @title Get feature vector by a specific well
#' 
#' @description Retrieves the features for a given well
#' 
...
#' @author Jan Sauer
#' 
#' @examples print(get_features_by_well)
#' @export
...
# Test
# configdir = "~/tmp/PROMISE_local/config"
# platename = "M001B04P009L02"
# row = "B"
# col = "12"
# feature_type = "inception"
# organoid_type = "mouse"
# compound = "Irinotecan"
# feats = get_features_by_compound(compound = compound, organoid_type = "mouse", feature_type = "inception", configdir = configdir)
