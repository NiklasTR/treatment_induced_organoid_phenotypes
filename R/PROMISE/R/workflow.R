...
#' @title Feature Extraction Workflow
#' 
#' @description This is the PROMISE workflow to extract texture features
#' 
#' @param plateIndir The directory name of the plate as generated by the microscope
#' @param platename The ID (and folder name) of the plate
#' @param row The row of the well
...
#' @author Jan Sauer
#' 
#' @examples print(PROMISEtexturefeatures)
#' @export
PROMISEtexturefeatures <- function(plateIndir, platename, row, col, configdir) {
  extractOrganoidFeatures_texture(plateIndir, platename, row, col, configdir)
  invisible(NULL)
}
