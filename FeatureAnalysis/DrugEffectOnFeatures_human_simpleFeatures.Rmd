---
title: "Feature Selection for Human Organoids based on Organoid Viability"
author: "Jan Sauer"
date: "10.10.2017"
output: 
  html_document:
...
```{r}
feature_of_interest = colnames(features_combined)[2]
simple_features = data.frame(
...
```{r}
feature_of_interest = colnames(features_combined)[11]
simple_features = data.frame(
  "Num.Objects" = features_combined[, feature_of_interest],
  "Num.Objects.Noise" = features_combined[, feature_of_interest],
  "Drug" = features_metadata_combined[, "DRUG"],
