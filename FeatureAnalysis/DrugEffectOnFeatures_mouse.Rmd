...
library(imageHTS)
library(pander)
library(here) #can be downloaded using CRAN
# Directories and files
 
config_dir = "/Volumes/collab/PROMISE/data-10x-4t-c-16z/configdir" #mount volume
feature_dir = paste0(here(), "/FeatureAnalysis/features")
source(file.path(config_dir, "watchdogConfig.R"))
blurrywells = paste0(here(), "/FilterBlurryWells/mouse/blurry_wells_predicted.txt")
...
* Combine plates belonging to a single replicate and calculate the z-score for each feature. This is necessary since considerable batch to batch variation was encountered during the screens. 
