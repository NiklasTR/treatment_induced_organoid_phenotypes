...
umap_sampled %>% filter(drug == "DMSO") %>% 
  ...
  theme_cowplot() + 
  ggsave(paste0(PATH, "notebooks/PhenotypeSpectrum/gg_size_dist_morph_ridge.pdf"), 
         width = 4, height = 4)
```
...
ggdrug_count + ggsave(paste0(PATH, "notebooks/PhenotypeSpectrum/gg_drug_dist_n_log.pdf"))
```
...
gg_tram_traj + ggsave(paste0(PATH, "notebooks/PhenotypeSpectrum/gg_tram_traj_D27_D19.pdf"), width = 4, height = 4)
```
