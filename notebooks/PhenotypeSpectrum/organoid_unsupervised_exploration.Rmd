...
=======
gg_size <- umap_size(umap_sampled)
>>>>>>> f929c08bfcdc5501e94f05f8939c4c516193e13e
...
<<<<<<< HEAD
cystic_l <- c("D018T01", "D013T01",  "D027T01", "D030T01")
dense_l <- c("D007T01", "D010T01", "D046T01", "D054T01", "D055T01")
...
=======
loi <- c("D018T01", "D013T01",  "D027T01", "D030T01")
...
plot_grid(plot_grid(gg_size_dist_morph_ridge, gg_size_replicate, labels = c('A', 'B'), label_size = 12, ncol = 2),
  ...
  ggsave(paste0(PATH, "reports/panel_size_dist.pdf"), width = 8, height = 16)
