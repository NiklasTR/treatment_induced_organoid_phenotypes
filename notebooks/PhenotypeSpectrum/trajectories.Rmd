...
```{r}
plot_grid(gg_bortezomib, gg_bortezomib_traj + coord_fixed(),
...
gg_big5_density <- umap_sampled %>%
  ...
  stat_density_2d(geom = "polygon",
        ...
        filter(line %in% c("D007T01", "D019T01", "D027T01", "D046T01")) %>%
...
gg_mek_traj_sel <- draw_trajectory_bulk(plot_df)
...
plot_grid(plot_grid(gg_traj_incl,gg_size_pc, labels = c('A', 'B'), label_size = 12, ncol = 2),
  ...
  ggsave(paste0(PATH, "reports/pseudotime_meki.pdf"), width = 8, height = 8)
```
...
gg_big5_density + ggsave(paste0(PATH, "reports/figures/gg_big5_density.pdf"), width = 8, height = 8)
```
