...
#  p3, p4,
  labels = "AUTO", ncol = 2
) +  ggsave(here::here("reports/gg_size_panel.pdf"), 
            width = 8,
            height = 4)
```
...
#  p3, p4,
  labels = "AUTO", ncol = 2
) +  ggsave(here::here("gg_ldc_panel.pdf"),
            width = 8,
            height = 4)
...
#  p3, p4,
  labels = "AUTO", ncol = 2
) +  ggsave(here::here("gg_replicate_panel.pdf"),
            width = 8,
            height = 4)
...
#  p3, p4,
  labels = "AUTO", ncol = 2
) +  ggsave(here::here("gg_screen_panel.pdf"),
            width = 8,
            height = 4)
...
umap_sampled %>%
  ...
  theme(legend.position = "bottom") + 
  ggsave(here::here("reports/figures/gg_actin.pdf"), width = 4, height = 4)
...
umap_sampled %>%
  ...
  theme(legend.position = "bottom") + 
  ggsave(here::here("reports/figures/gg_dapi.pdf"), width = 4, height = 4)
...
plot_grid(
  p1, p2,
 # p3, p4,
  labels = "AUTO", ncol = 2) +  ggsave(here::here(paste0("gg_morph_panel", loi, ".pdf")), 
            width = 8,
            height = 8)
