...
# organoid size, viability and LDC classification
...
cor(df$ldc, df$size, use = "complete.obs") %>% round(digits = 4)
cor(df$ctg, df$size, use = "complete.obs") %>% round(digits = 4)
```
