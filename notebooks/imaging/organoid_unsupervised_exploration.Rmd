...
gg_cluster + ggsave(here("reports/figures/imaging/gg_cluster.pdf"), width = 4, height = 4)
...
gg_size_dist_log + ggsave(here("reports/figures/imaging/gg_size_dist.pdf"), width = 4, height = 4)
```
...
gg_size  + ggsave(paste0(PATH, "reports/figures/imaging/gg_size_all.pdf"))
```
...
gg_size_supp + ggsave(paste0(PATH, "reports/figures/imaging/gg_size_all.pdf"))
```
...
gg_line + ggsave(paste0(PATH, "reports/figures/imaging/gg_size_all.pdf"), width = 4, height = 4)
```
