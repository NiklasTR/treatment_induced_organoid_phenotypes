...
params:
  ...
  sample: "data/processed/PhenotypeSpectrum"
  output: "imaging"
  remote: FALSE
  cache: FALSE
---
...
umap_df_sample <- list.files(here::here(params$sample))
...
plot_grid(gg_bortezomib + coord_fixed(), gg_bortezomib_traj + coord_fixed(),
  ...
  ggsave(here::here("reports/panel_bortezomib.pdf"), width = 8, height = 4)
