...
heatmap_pathways = oddsratio_pathway[, c("Line", "Label", "OddsRatio")] %>% filter(!Line %in% c("D021T01", "D054T01", "D055T01", "D20T02"))
...
heatmap_targets = oddsratio_target[, c("Line", "Label", "OddsRatio")] %>% filter(!Line %in% c("D021T01", "D054T01", "D055T01", "D20T02"))
