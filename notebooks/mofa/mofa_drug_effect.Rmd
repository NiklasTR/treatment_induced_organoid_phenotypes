...
```{r}
# input data
morphology_profile <- readRDS(here::here("data/processed/imaging/pca_absolute_all_drugs_aggregate.Rds"))
...
# additional data
## UMAP morphology
umap_df <- readRDS(here::here("data/processed/imaging/umap_absolute_all_drugs_sampled.Rds"))
