...
filelist <- list.files('/Volumes/collab-bernd-fischer/PROMISE/ctg_data/', pattern = 'L08.TXT')
dir <- "/Volumes/collab-bernd-fischer/PROMISE/ctg_data/"
...
Clin_Cancer_Panel_V170511 <- read_csv("/Volumes/collab-bernd-fischer/PROMISE/layouts/Clin_Cancer_Panel_V170511.csv")
